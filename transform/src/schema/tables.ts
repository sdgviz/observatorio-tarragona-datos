...
export const CREATE_INDICADORES_AGENDAS = `
CREATE TABLE IF NOT EXISTS INDICADORES_AGENDAS (
...
export const CREATE_INDICADORES_ODS = `
CREATE TABLE IF NOT EXISTS INDICADORES_ODS (
  id_indicador TEXT NOT NULL,
  codigo_ine TEXT NOT NULL,
  periodo INTEGER NOT NULL,
  valor REAL,
...
export const ALL_DDL = [
  ...
  CREATE_INDICADORES_AGENDAS,
  CREATE_INDICADORES_ODS,
