## Purpose
The `DoubleSpiderMinMax` component is a data-independent radar/spider chart that accepts configurable axis count, colors, and labels via props, enabling reuse across ODS (17 axes) and AU (10 axes) taxonomies without internal taxonomy-specific imports.
