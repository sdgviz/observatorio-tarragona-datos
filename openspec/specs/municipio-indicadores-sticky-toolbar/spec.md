# municipio-indicadores-sticky-toolbar

## Purpose

Sticky chrome on the municipio **Indicadores** tab so ODS navigation, text filter, and Lista/Dashboard tabs stay usable while scrolling long indicator content.
