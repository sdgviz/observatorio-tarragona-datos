...
- **Código afectado**:
  ...
  - Opcionalmente integración con el repositorio Nuxt solo a efectos de despliegue en GitHub Pages (por ejemplo, compartiendo la carpeta `githubpage/`), pero la web en sí debe ser autocontenida.
- **Datos afectados**:
